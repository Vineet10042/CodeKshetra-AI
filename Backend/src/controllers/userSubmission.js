...
const submitCode = async (req, res) => {
  ...
  try {
    ...
    if (accepted && !req.result.problemSolved.includes(problemId)) {
      ...
      if (problem.difficulty.toLowerCase() === 'easy') pointsAwarded = 2;
      else if (problem.difficulty.toLowerCase() === 'medium') pointsAwarded = 4;
      else if (problem.difficulty.toLowerCase() === 'hard') pointsAwarded = 8;

      req.result.score = (req.result.score || 0) + pointsAwarded;
